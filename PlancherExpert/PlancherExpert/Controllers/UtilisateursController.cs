    ...
    public class UtilisateursController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Utilisateur != null ? 
                          ...
                          Problem("Entity set 'AppDbContext.Utilisateur'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Name,Email,Password,Id")] Utilisateur utilisateur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Email,Password,Id")] Utilisateur utilisateur)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDbContext.Utilisateur'  is null.");
            }
            var utilisateur = await _context.Utilisateur.FindAsync(id);
            if (utilisateur != null)
            {
