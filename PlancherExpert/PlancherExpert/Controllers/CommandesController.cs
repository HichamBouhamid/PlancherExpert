    ...
    public class CommandesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Commande != null ? 
                          ...
                          Problem("Entity set 'AppDbContext.Commande'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,longueur,largeur,User_Id,CP_Id")] Commande commande)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,longueur,largeur,User_Id,CP_Id")] Commande commande)
        {
            if (id != commande.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDbContext.Commande'  is null.");
            }
            var commande = await _context.Commande.FindAsync(id);
            if (commande != null)
            {
